// Auto-generated from ref/font.h

/// 6x8 ASCII font, offset 32 (space). Total 96 chars.
pub static F6X8: [[u8; 6]; 92] = [
...
/// 8x16 ASCII font, offset 32 (space). Total 95 chars, 16 bytes each.
pub static F8X16: [[u8; 16]; 95] = [
